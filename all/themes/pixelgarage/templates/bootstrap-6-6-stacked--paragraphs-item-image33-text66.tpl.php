...
<<?php print $layout_wrapper; print $layout_attributes; ?> class="<?php print $full_width; print $classes; ?>">
  ...
  <?php if ($left || $right): ?>
    <div class="row">
      <<?php print $left_wrapper; ?> class="col-lg-4 left <?php print $switch; print $left_classes; ?>">
        <?php print $left; ?>
        <div class="field-text-extra left"><?php print $bottom; ?></div>
      </<?php print $left_wrapper; ?>>
      <<?php print $right_wrapper; ?> class="col-lg-8 right <?php print $switch; print $right_classes; ?>">
        <?php print $right; ?>
