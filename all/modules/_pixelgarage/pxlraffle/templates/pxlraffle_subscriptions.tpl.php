...
<div id="<?php print $container_id; ?>">
  ...
  <div class="subscriptions">
    ...
    <div class="actions">
      <a class="btn btn-default link-subscribe" href="<?php print $subscription_link_url; ?>"><?php print $subscription_link_label; ?></a>
    </div>
    <div class="odometer-users">
      <div class="odometer"><?php print $subscribed_users; ?></div>
      <div class="odometer-label"><?php print $subscribed_users_label; ?></div>
    </div>
